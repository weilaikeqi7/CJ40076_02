...
void HAL_QSPI_MspInit(QSPI_HandleTypeDef* qspiHandle)
{
  ...
  /* USER CODE END QUADSPI_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = QSPI_DO2_Pin|QSPI_DO0_Pin|QSPI_DO1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF9_QSPI;
    ...
    hdma_quadspi.Init.FIFOThreshold = DMA_FIFO_THRESHOLD_HALFFULL;
    hdma_quadspi.Init.MemBurst = DMA_MBURST_INC4;
    hdma_quadspi.Init.PeriphBurst = DMA_PBURST_INC4;
...
void HAL_QSPI_MspDeInit(QSPI_HandleTypeDef* qspiHandle)
{
  ...
  /* USER CODE END QUADSPI_MspDeInit 0 */
    ...
    PB6     ------> QUADSPI_BK1_NCS
    */
    HAL_GPIO_DeInit(QSPI_DO3_GPIO_Port, QSPI_DO3_Pin);

    HAL_GPIO_DeInit(GPIOB, QSPI_SCK_Pin|QSPI_CSN_Pin);

    HAL_GPIO_DeInit(GPIOC, QSPI_DO2_Pin|QSPI_DO0_Pin|QSPI_DO1_Pin);
